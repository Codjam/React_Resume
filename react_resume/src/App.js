          ...
          <div className="sidebar-wrapper">
              ...
              <div className="contact-container container-block">
                  <ul className="list-unstyled contact-list">
                      <li className="email"><i className="fa fa-envelope"></i><a href="mailto: jamaltbutler@gmail.com">{resume.email}</a></li>
          ...
          <div className="main-wrapper">
              ...
              <section className="section summary-section">
                  ...
                  <div className="summary">
                      ...
                      <p>Recently, I have been enjoying the many conversations with friends that have been showing me how different languages through the computer can produce specific things on the computer. Also, I finished a 24-week boot camp at GW. I have posted some of my work on GitHub (Link on the sidebar).  </p>
